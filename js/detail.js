...
$(function(){
    ...
    $('.full_screen').on('touchstart',function(){
        ...
        var h = $('.screen_content').children('div').children('div:last');
        var currentClass = h.attr('class');
        var viewIndex = h.attr('data-index');

        function chartH(){
            var legendFilterH = $('.screen_content').children().children().eq(0).outerHeight(true);
            var screenH = $(document).height() - legendFilterH - 54 + 'px';
            return screenH;
        }
        /*地图on事件判断*/
        /*if(currentClass == 'legendMap'){
         ...
         myChart.setOption(viewoption03);
